...
import { ContainerOpenCloseProvider } from './FlexLayoutHooks';
import styles from './styles/FlexLayout.module.css';

import { FlexLayoutProvider } from './FlexLayoutContext';
...
const FlexLayout = ({
    ...
    const nodes = Children.toArray(children).flatMap(node =>
        isFragmentElement(node) ? Children.toArray(node.props.children) : [node]
    );
