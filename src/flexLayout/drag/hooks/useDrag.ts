...
import { DropDocumentOutsideOption } from './../../FlexLayoutSplitScreenDragBox';
...
export interface DropTargetComponentEvent
    extends Omit<DropTargetComponent, 'containerName' | 'component'> {
