...
import { dragState, useDragEvents } from './drag/hooks/useDrag';

import { isDocumentOut } from './FlexLayoutUtils';
...
export default function FlexLayoutSplitScreenDragBox<E extends HTMLElement>({
    ...
    const clonedNodeRef = useRef<HTMLDivElement>(null);
    const clonedWidth = useRef<number>(null);
    const clonedHeight = useRef<number>(null);
