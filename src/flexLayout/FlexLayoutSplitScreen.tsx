...
import {
    ...
    DropTargetComponent,
} from './drag/hooks/useDrag';
import { useFlexLayoutSplitScreen } from './drag/hooks/useFlexLayoutSplitScreen';
...
const handleUpdateDropTargetComponents = ({
    ...
    */
    ...
    const newComponent = {
        ...
        screenKey:
            screenKey ||
            Array.from(window.crypto.getRandomValues(new Uint32Array(16)), e =>
